        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_orders_discount_non_negative", "`Discount` >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_order_items_subtotal_non_negative", "`Subtotal` >= 0");
                    table.CheckConstraint("CK_order_items_unit_price_non_negative", "`UnitPrice` >= 0");
                    table.ForeignKey(
